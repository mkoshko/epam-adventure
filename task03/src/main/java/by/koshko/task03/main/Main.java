...
public class Main {
    ...
    public static void main(final String[] args) {
        ...
        joiner.add("\tThe      organization of a simple bus-oriented computer is shown in Fig. 2-1.\n\tTheCPU(Central Processing Unit) is the ‘‘brain’’ of the computer.\n Its function is to execute programs stored in the main memory by fetching their instructions, examining them, and then executing them one after another.\n The components are connected by a bus, which is a collection of parallel wires for transmitting address,data, and control signals. Buses can be external to the CPU, connecting it to mem-ory and I/O devices, but also internal to the CPU, as we will see shortly. Modern computers have multiple buses.");
...
//        System.out.print(text.getChild(0).getChild(0).getChild(0).getChild(0).compose());
